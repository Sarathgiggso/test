...
if __name__ =="__main__":
    #    url = "http://0.0.0.0:8202/smartInsights/getSimilarConversations"
    url = "http://10.233.51.238:8202/smartInsights/getRecommendedSolutions"
    #feed_id ='pzKTtXcBhYoF8uCkSMMa'
    feed_id = 340768
#    feed_id = 345034 #344933  #344839#344458#343744#343600
    user_id = 8
